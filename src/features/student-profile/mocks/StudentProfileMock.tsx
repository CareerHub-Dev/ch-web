...
const trendingPosts = [
    {
        ...
        body: "Lorem impsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        comments: 291,
    },
    {
        id: 2,
    ...
    },
    {
        ...
        body: "Just imagine Writing the whole really (I mean, REALLY) large app in Typescript and seeing VSCode going slideshow trying to process the whole LSP stuff. Hate it.",
        comments: 4,
    },
];

export default function StudentProfileMock() {
    return (
        <>
