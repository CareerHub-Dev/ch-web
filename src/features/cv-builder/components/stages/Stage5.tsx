            ...
            {isAssistEnabled && (
                <div className="mt-6 flex flex-col gap-4">
                    <AssistanceAlert title="Що варто вказати?">
                        <p>
                            Важливо вказати іноземні мови, які будуть корисні в
                            роботі. Скоріше за все, работодавці будуть
                            цікавитися вашим рівнем англійської
                        </p>
                    </AssistanceAlert>
