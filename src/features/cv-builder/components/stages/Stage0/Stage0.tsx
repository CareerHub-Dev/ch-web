            ...
            <div className="space-y-6 sm:space-y-5">
                <div>
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        Загальна інформація про тип роботи та вибір мови, на
                        якій створюватиметься резюме
                    </p>
                </div>
            ...
            {isAssistEnabled ? (
                <div className="mt-6 space-y-6">
                    <AssistanceAlert title="Оберіть напрямок та посаду">
                        <p>
                            Для продовження необхідно обрати напрямок та посаду
                        </p>
                    </AssistanceAlert>

                    <AssistanceAlert title="Мова шаблону" type={"info"}>
                        <p>
                            У сфері IT всюди використовується англійська мова,
                            тому у якості мови шаблону краще обрати саме її.
                        </p>
                    </AssistanceAlert>
                </div>
            ) : null}
