        ...
        <>
            <div className="space-y-6 sm:space-y-5">
                ...
                {isAssistEnabled ? (
                    <AssistanceAlert title="Цей пункт можна пропустити">
                        <p>
                            Якщо ви не маєте жодного досвіду роботи, ви можете
                            пропустити цей пункт, відмітивши поле вище.
                        </p>
                    </AssistanceAlert>
                ) : null}
                <ProjectLinks />
            ...
            {isAssistEnabled ? (
                <div className="mt-6 flex flex-col gap-4">
                    <AssistanceAlert>
                        <p>
                            Ще можна залишити корисні посилання на власні
                            проекти для демонстрації.
                        </p>
                    </AssistanceAlert>
                    ...
                    <AssistanceAlert type="negative">
                        <p>
                            Не потрібно залишати посилання на непрофесійні
                            соцмережи
                        </p>
                    </AssistanceAlert>
                </div>
